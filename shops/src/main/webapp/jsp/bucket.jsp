			...
			<div class="list-group" style="margin-top: 40px">
				...
				<security:authorize access="hasRole('ROLE_ADMIN')">
					<a href="/create-product" class="list-group-item"> <i
						class="fa fa-search"></i><spring:message code='sidebar.create_product'/>
					</a>
				</security:authorize>
					...
					<tbody>
						<c:forEach var="bucket" items="${bucketItems}">
							<tr style="height: 10%">
								...
								<td><img src="data:image/jpg;base64,${bucket.product.encodedImage}" alt="image" style="width: 30%; height: 50%"></td>
