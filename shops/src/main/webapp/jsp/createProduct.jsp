		...
		<div class="w3-sidebar" style="width: 10%">
			...
			<div class="list-group" style="margin-top: 40px">
				...
				<security:authorize access="hasRole('ROLE_ADMIN')">
					<a href="/create-product" class="list-group-item"> <i
						class="fa fa-search"></i>
					<spring:message code='sidebar.create_product' />
					</a>
				</security:authorize>
				...
				<form:form method="POST" action="${contextPath}/addProduct"
					...
					<div class="form-group">
						...
						<input class="form-control"
							aria-describedby="name" name="name" placeholder="<spring:message code='product.name'/>">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control"
							aria-describedby="Description" name="Description" placeholder="<spring:message code='product.description'/>">
					</div>
					
					<div class="form-group">
						<label for="Price"><spring:message code='product.price'/></label> 
						<input class="form-control"
							aria-describedby="Price" name="price" placeholder="<spring:message code='product.price'/>">
					</div>
					
					<div class="form-group">
						<label for="image"><spring:message code='product.select_image'/></label> 
						<input class="form-control"
